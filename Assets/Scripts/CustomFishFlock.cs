...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class CustomFishFlock : MonoBehaviour
{
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    IEnumerator Danger()
    {
        ...
        if (danger)
        {
            ...
            while (true)
            {
                ...
                Collider[] dangers = new Collider[10];
                int size = Physics.OverlapSphereNonAlloc(dangerTransform.position, dangerRadius, dangers, dangerLayer);
                if (size > 0)
                {
